...
exports.GET_WIN_ID_CHANNEL = GET_WIN_ID_CHANNEL; exports.INVOKE_CHANNEL = INVOKE_CHANNEL; exports.formatChannelName = formatChannelName; exports.TIpcFunc = TIpcFunc;
